          ...
          <div class="my-2 border-t border-gray-200 dark:border-gray-700 pt-2">
            ...
            <template v-if="shopStore.myShops.length">
              <NuxtLink
                ...
                class="mt-1 flex items-center gap-3 rounded-lg px-3 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800"
            ...
            <NuxtLink
              ...
              class="mt-2 flex items-center gap-3 rounded-lg px-3 py-2 text-sm font-medium text-primary-600 dark:text-primary-400 hover:bg-primary-50 dark:hover:bg-primary-900/20"
            >
