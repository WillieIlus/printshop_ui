<template>
  <div class="space-y-8">
    ...
    <template v-else-if="shop">
      ...
      <!-- Machines / Equipment -->
      <div v-if="shop.machines?.length" class="bg-white dark:bg-gray-900 rounded-xl shadow-sm p-6 border border-gray-200 dark:border-gray-700">
      ...
      <div id="rate-card">
        ...
        <PricingRateCardDisplay 
          ...
          :shop-name="shop.name"
        />
        <div v-else-if="!pricingStore.loading" class="bg-white dark:bg-gray-900 rounded-xl shadow-sm p-8 text-center border border-gray-200 dark:border-gray-700">
          <svg class="mx-auto h-12 w-12 text-gray-400 dark:text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 7h6m0 10v-3m-3 3h.01M9 17h.01M9 14h.01M12 14h.01M15 11h.01M12 11h.01M9 11h.01M7 21h10a2 2 0 002-2V5a2 2 0 00-2-2H7a2 2 0 00-2 2v14a2 2 0 002 2z" />
          </svg>
          <h3 class="mt-4 text-lg font-medium text-gray-900 dark:text-white">Pricing not available</h3>
          <p class="mt-2 text-sm text-gray-500 dark:text-gray-400">This shop hasn't published their rate card yet.</p>
          <p class="mt-4 text-sm text-gray-600 dark:text-gray-400">Contact them directly or request a custom quote.</p>
