<template>
  <div>
    ...
    <!-- Hero (from sample.txt – works in light/dark) -->
    <section id="top" class="relative overflow-hidden bg-gray-900 dark:bg-gray-950 py-20 sm:py-32">
        ...
        <div class="lg:grid lg:grid-cols-2 lg:gap-16 lg:items-center">
          <div class="max-w-2xl">
            ...
            <div class="mt-8 flex flex-col sm:flex-row gap-4">
              <UButton to="/#demo-gallery" size="lg" color="white" trailing-icon="i-lucide-arrow-down">
                View Gallery Demo
              </UButton>
              <UButton to="/#models" size="lg" variant="outline" color="white">
                How Pricing Works
              </UButton>
            </div>
          </div>
    ...
    <!-- Gallery CTA -->
    <section id="demo-gallery" class="py-16 sm:py-24 bg-gray-50 dark:bg-gray-800/50 border-t border-gray-200 dark:border-gray-700">
      <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center">
        ...
        <UButton to="/auth/login" size="lg" color="primary" class="mt-8">
    ...
    <section id="models" class="py-16 sm:py-24 bg-white dark:bg-gray-900">
      <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="max-w-2xl">
          <p class="text-sm font-bold uppercase tracking-wider text-gray-500">Under the Hood</p>
          <h2 class="mt-2 text-3xl font-extrabold tracking-tight text-gray-900 dark:text-white sm:text-4xl">
        ...
        <div class="mt-10 grid gap-8 lg:grid-cols-2">
          <UCard class="rounded-3xl">
            ...
            <div class="rounded-xl bg-gray-50 dark:bg-gray-800 p-4 font-mono text-sm text-gray-700 dark:text-gray-300 space-y-1">
    ...
    <!-- CTA & Footer -->
    <section id="cta" class="py-16 sm:py-24 bg-gray-900 dark:bg-gray-950 text-white">
      <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div class="flex flex-col sm:flex-row gap-4 justify-center">
          ...
          <UButton to="/#demo-gallery" size="lg" variant="outline" color="white">
            Back to Gallery
          </UButton>
        </div>
      </div>
    ...
    <footer class="bg-gray-900 dark:bg-gray-950 border-t border-gray-800 py-10">
      <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row justify-between items-center gap-6">
        <div class="flex items-center gap-2">
          ...
          <span class="text-gray-400 text-sm">© {{ new Date().getFullYear() }} PrintShop. All rights reserved.</span>
        </div>
