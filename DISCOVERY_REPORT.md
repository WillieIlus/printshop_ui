...
This workspace is a **frontend-only** Nuxt 4 project. The backend (Django REST Framework) is a separate service at `NUXT_PUBLIC_API_BASE` (e.g. `http://localhost:8000/api`). No backend Python code exists in this repo.
